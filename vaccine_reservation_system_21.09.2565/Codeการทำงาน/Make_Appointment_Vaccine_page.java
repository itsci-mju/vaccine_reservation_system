    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        myRef_show_date.addListenerForSingleValueEvent(new ValueEventListener() {
            ...
            public void onDataChange(@NonNull DataSnapshot snapshot) {
                ...
                for(int i = 1 ; i < Date_color.size() ; i++ ){
                    //int date = Integer.parseInt(Date_color.get(i));
                    if(Date_color.equals("05")){
...
//        dateHashMap.put(28,"absent");
        ...
        customCalendar.setOnDateSelectedListener(new OnDateSelectedListener() {
            ...
            public void onDateSelected(View view, Calendar selectedDate, Object desc) {
                ...
                if(selectedDate.get(Calendar.DAY_OF_MONTH) != Integer.parseInt(String.valueOf(14))&&selectedDate.get(Calendar.DAY_OF_MONTH) != Integer.parseInt(String.valueOf(15))&&selectedDate.get(Calendar.DAY_OF_MONTH) != Integer.parseInt(String.valueOf(16))){
