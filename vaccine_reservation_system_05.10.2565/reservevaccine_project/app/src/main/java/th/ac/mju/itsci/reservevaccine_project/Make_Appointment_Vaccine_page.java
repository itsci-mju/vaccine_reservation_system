        ...
        customCalendar.setOnDateSelectedListener(new OnDateSelectedListener() {
            ...
            public void onDateSelected(View view, Calendar selectedDate, Object desc) {
                ...
                for(int i = 0 ; i < Date_list.size() ; i++ ) {
                    ...
                    if(Integer.parseInt(Date_Full.substring(0,2)) == selectedDate.get(Calendar.DAY_OF_MONTH)){
                        DatabaseReference myRef_check_queue = database.getReference("Login/admin1234/Schedule_time/"+Date_list.get(i));
                        Query query2 = myRef_check_queue.orderByKey();
                        query2.addValueEventListener(new ValueEventListener() {
                            ...
                            public void onDataChange(@NonNull DataSnapshot snapshot) {
                                for(DataSnapshot ds : snapshot.getChildren()) {
                                    String status = ds.child("status").getValue().toString();
                                    Log.e("status_date_Full ",status);
                                    if(status.equals("เต็ม")){
                                        Full_Date = Date_Full.substring(0,2);
                                        Log.e("Full_Date IF",Full_Date);
...
//                                        Log.e("Integer.parseInt((Date_Full.substring(0,2))) ",String.valueOf(Integer.parseInt((Date_Full.substring(0,2)))));
                        ...
                        Full_Date = Date_Full.substring(0,2);
                        Log.e("Date_Full ELSE",Full_Date);
                    }
                   ...
                   // String date_sub = Date_list.get(i);
                    ...
                    if ((selectedDate.get(Calendar.DAY_OF_MONTH) == Integer.parseInt((Date_Full.substring(0,2)))) && (selectedDate.get(Calendar.DAY_OF_MONTH) != Integer.parseInt(Full_Date))) {
                        dialog_date = 20;
                        //Get string date
