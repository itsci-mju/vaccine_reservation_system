...
public class list_vaccine_page extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        myRef_list_vaccine.addListenerForSingleValueEvent(new ValueEventListener() {
            @Override
            public void onDataChange(@NonNull DataSnapshot snapshot) {
                ...
                for(int i = 0 ; i < VaccineList.size() ; i++){
                    DatabaseReference myRef  = database.getReference("Login/"+Username+"/Vaccine/"+VaccineList.get(i));
