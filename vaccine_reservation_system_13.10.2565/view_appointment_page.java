...
public class view_appointment_page extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        bottomNavigationView.setSelectedItemId(R.id.viewAppointment);
        ...
        DatabaseReference myRef = database.getReference("Login/"+Username+"/Reserve/Reserve_List/1/Reserve_Deatails/Appointment");
        ...
        Query query3 = myRef_vaccine_name.orderByKey().equalTo("1");
