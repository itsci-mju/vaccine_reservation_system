...
public class Make_Appointment_Vaccine_page extends AppCompatActivity {
    ...
    List<String> Color_status = new ArrayList<>();
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        final RadioButton myRadioButton1 = (RadioButton) findViewById(R.id.radioButton_time_1);
        final RadioButton myRadioButton2 = (RadioButton) findViewById(R.id.radioButton_time_2);
        final RadioButton myRadioButton3 = (RadioButton) findViewById(R.id.radioButton_time_3);
        final RadioButton myRadioButton4 = (RadioButton) findViewById(R.id.radioButton_time_4);
        final RadioButton myRadioButton5 = (RadioButton) findViewById(R.id.radioButton_time_5);
        ...
        myRef_show_date.addListenerForSingleValueEvent(new ValueEventListener() {
            ...
            public void onDataChange(@NonNull DataSnapshot snapshot) {
                ...
                for(int i = 0 ; i < Date_list.size() ; i++ ){
                    ...
                    DatabaseReference myRef_check_queue = database.getReference("Login/admin1234/Schedule_time/"+Date_list.get(i));
...
//                                    total_count += 1;
//                                    Count_status.add(String.valueOf(total_count));
...
//                                Log.e("Count_status ", Count_status.toString());


//                                Count_status.add(String.valueOf(total_count));
//                                Log.e("Color_status ", Count_status.toString());
        ...
        customCalendar.setOnDateSelectedListener(new OnDateSelectedListener() {
            ...
            public void onDateSelected(View view, Calendar selectedDate, Object desc) {
                ...
                for(int i = 0 ; i < Date_list.size() ; i++ ) {
                    ...
                    if(Integer.parseInt(Date_color.get(i)) == Integer.parseInt(String.valueOf(selectedDate.get(Calendar.DAY_OF_MONTH)))){
                        ...
                        DatabaseReference myRef_show_time = database.getReference("Login/admin1234/Schedule_time/"+Date_list.get(i));
                        Query query2 = myRef_show_time.orderByKey().equalTo("1");
                            ...
                            public void onDataChange(@NonNull DataSnapshot snapshot) {
                                for(DataSnapshot ds : snapshot.getChildren()) {
                                    ...
                                    if(status.equals("เต็ม")){
                                        Full_Date = "0";
                                        Log.e("วันนี้เต็มแล้ว ",Full_Date);
...
//                                        Log.e("Integer.parseInt((Date_Full.substring(0,2))) ",String.valueOf(Integer.parseInt((Date_Full.substring(0,2)))));
                                        ...
                                        Full_Date = "1";
                                        Log.e("วันนี้ยังไม่เต็ม ",Full_Date);
                                        ...
                                        if (Full_Date.equals("1") ) {
                                            Log.e("เข้ามาแล้วใน IF กำลังสร้าง TableLayout ",Full_Date);
                                            dialog_date = 20;
                                            //Get string date
...
//                                }
                                            ...
                                            DatabaseReference myRef_check_vaccineNo = database.getReference("Login/" + Username + "/" + "Reserve/Reserve_List/1");
                                                        ...
                                                        public void onClick(View v) {
                                                            ...
                                                            if (checkedId == -1) {
                                                                ...
                                                                if (Appointment_Check.equals("Appointment_1")) {
                                                                    ...
                                                                    DatabaseReference myRef_Schedule_Appointments = database.getReference("Login/" + Username + "/" + "Reserve/Reserve_List/1/Reserve_Deatails/Appointment");
